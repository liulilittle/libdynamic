...
inline unsigned short __ntohs(unsigned short n) noexcept {
    unsigned short r = 0;
    unsigned char* p1 = (unsigned char*)&n;
    unsigned char* p2 = (unsigned char*)&r;
...
inline unsigned int __ntohl(unsigned int n) noexcept {
    unsigned int r = 0;
    unsigned char* p1 = (unsigned char*)&n;
    unsigned char* p2 = (unsigned char*)&r;
...
inline unsigned int __htonl(unsigned int n) noexcept {
    return __ntohl(n);
}

inline unsigned short __htons(unsigned short n) noexcept {
    return __ntohs(n);
}
...
inline unsigned short ip_standard_chksum(void* dataptr, int len) noexcept {
    ...
    return __ntohs((unsigned short)acc);
}
...
inline unsigned int FOLD_U32T(unsigned int u) {
...
inline unsigned short inet_cksum_pseudo_base(unsigned char* payload, unsigned int proto, unsigned int proto_len, unsigned int acc) noexcept {
    ...
    acc += __htons((unsigned short)proto);
    acc += __htons((unsigned short)proto_len);
